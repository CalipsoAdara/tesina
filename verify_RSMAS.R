...
#  Main Program  
#---------------------------------------------------------------------------------------
ar.model = readRDS("/home/lucia.castro/SubX_processed_Rdata/model_RSMAS_ONDEFM.rds")
targetdate = readRDS("/home/lucia.castro/SubX_processed_Rdata/targetdate_RSMAS_ONDEFM.rds")
...
fig <- grid.arrange(g1,g2,g3,g4, ncol = 1,top = textGrob("SubX RSMAS-CCSM4 T2MA (99-14, Oct-Mar)",gp=gpar(fontsize=13,font=3)))
...
saveRDS(model_media_semanal, paste0("./SubX_processed_Rdata/modelweek_RSMAS.rds"))
saveRDS(anom_media_semanal, paste0("./SubX_processed_Rdata/obsweek_RSMAS.rds"))
saveRDS(metrics, "./SubX_processed_Rdata/metrics_RSMAS.rds")
