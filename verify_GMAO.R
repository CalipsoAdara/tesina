...
for (lon in 1:66) {
  for (lat in 1:76) {
    # Media semanal
    df.medsemana = PromediarSemanas(lon,lat,ar.anom)
...
fig <- grid.arrange(g1,g2,g3,g4, ncol = 1,top = textGrob("SubX GMAO-GEOS_V2p1 T2MA (99-14, Oct-Mar)",gp=gpar(fontsize=13,font=3)))
...
saveRDS(metrics, "./SubX_processed_Rdata/metrics_GMAO.rds")
